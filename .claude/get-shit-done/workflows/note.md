...
- **Global scope**: `/Users/mcmurdie/Development/personal/library-choices/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mcmurdie/Development/personal/library-choices/.claude/notes/`)
...
2. Glob `/Users/mcmurdie/Development/personal/library-choices/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mcmurdie/Development/personal/library-choices/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mcmurdie/Development/personal/library-choices/.claude/notes/` — works in any directory
